...
public class WeatherSpec implements Parcelable {
    ...
    public static class Forecast implements Parcelable {
        ...
        {
            this (minTemp, maxTemp, conditionCode, humidity, '\0');
        }

        public Forecast(int minTemp, int maxTemp, int conditionCode, int humidity, char moon) {
            this (minTemp, maxTemp, conditionCode, humidity, moon, -1, null);
        }

        public Forecast(int minTemp, int maxTemp, int conditionCode, int humidity, char moon, int precipProbability, String condition) {
            this.minTemp = minTemp;
            this.maxTemp = maxTemp;
            this.conditionCode = conditionCode;
            this.humidity = humidity;
            this.moon = moon;
            this.precipProbability = precipProbability > 0 ? precipProbability : -1;
