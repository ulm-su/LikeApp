...
public class AppNotificationType extends HashMap<String, NotificationType> {
    ...
    private AppNotificationType() {
        ...
        put("com.synology.dsmail", NotificationType.GENERIC_EMAIL);
        put("ru.mail.mailapp", NotificationType.GENERIC_EMAIL);
        put("com.metalsoft.trackchecker_mobile", NotificationType.GENERIC_EMAIL);
        put("com.octopod.russianpost.client.android", NotificationType.GENERIC_EMAIL);
        put("com.my.mail", NotificationType.GENERIC_EMAIL);
        ...
        put("com.google.android.googlequicksearchbox", NotificationType.WEATHER);
        ...
        // ВКонтакте
        put("com.vkontakte.android", NotificationType.VKONTAKTE);

        // 4PDA
        put("ru.fourpda.client", NotificationType.FOUR_PDA);

        // ВТБ
        put("ru.vtb24.mobilebanking.android", NotificationType.VTB_ONLINE);
        put("ru.advisa.smartsms", NotificationType.SMART_SMS);

        // Сбербанк
        put("ru.sberbankmobile", NotificationType.SBERBANK);

        // SofaScore
        put("com.sofascore.results", NotificationType.SOFA_SCORE);

        // DS note
        put("com.synology.dsnote", NotificationType.DSM);
        // DS drive
        put("com.synology.dsdrive", NotificationType.DSM);
        // DS file
        put("com.synology.dsfile", NotificationType.DSM);

        // Chrome
        put("com.android.chrome", NotificationType.CHROME);

        // Bluetooth
        put("com.android.bluetooth", NotificationType.BLUETOOTH);

        // Youtube
        put("com.google.android.youtube", NotificationType.YOUTUBE);

        // AliExpress
        put("com.alibaba.aliexpresshd", NotificationType.ALI_EXPRESS);

        // Mi Home
        put("com.xiaomi.smarthome", NotificationType.MI_HOME);
        // Xiaomi Service Framework
        put("com.xiaomi.xmsf", NotificationType.MI_HOME);
        // Mi Picks
        put("com.xiaomi.mipicks", NotificationType.MI_HOME);
        // MIUI Security
        put("com.miui.securitycenter", NotificationType.MI_HOME);

        // MOS PGU
        put("ru.altarix.mos.pgu", NotificationType.GENERIC_SMS);

        // Будильник
        put("com.android.deskclock", NotificationType.GENERIC_ALARM_CLOCK);

        // Загрузка
        put("com.android.providers.downloads", NotificationType.GENERIC_SMS);
        put("com.android.providers.downloads.ui", NotificationType.GENERIC_SMS);
