...
import org.likeapp.likeapp.devices.pebble.PebbleIconID;
...
public enum NotificationType {
    ...
    BATTERY_LOW(PebbleIconID.GENERIC_SMS, PebbleColor.DarkCandyAppleRed),
    BATTERY_FULL(PebbleIconID.GENERIC_SMS, PebbleColor.DarkGreen),
    VKONTAKTE(PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    FOUR_PDA(PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    VTB_ONLINE (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    SMART_SMS (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    SOFA_SCORE (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    DSM (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    CHROME (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    BLUETOOTH (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    SBERBANK (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    YOUTUBE (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    ALI_EXPRESS (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    MI_HOME (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
    WEATHER (PebbleIconID.GENERIC_SMS, PebbleColor.IslamicGreen),
