...
import org.likeapp.likeapp.model.NotificationSpec.Action;
...
public class PebbleProtocol extends GBDeviceProtocol {
    ...
    public byte[] encodeFindDevice(boolean start) {
        return encodeSetCallState("Where are you?", "LikeApp", start ? CallSpec.CALL_INCOMING : CallSpec.CALL_END);
        /*
