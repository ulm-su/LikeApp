...
package org.likeapp.likeapp.service.devices.qhybrid.adapter.fossil;
...
import org.likeapp.likeapp.devices.qhybrid.PackageConfigHelper;
...
import org.likeapp.likeapp.service.devices.qhybrid.buttonconfig.ConfigFileBuilder;
...
import org.likeapp.likeapp.service.devices.qhybrid.requests.fossil.alarm.AlarmsSetRequest;
...
import org.likeapp.likeapp.service.devices.qhybrid.requests.fossil.notification.PlayNotificationRequest;
...
import static org.likeapp.likeapp.service.devices.qhybrid.QHybridSupport.ITEM_TIMEZONE_OFFSET;
...
import static org.likeapp.likeapp.service.devices.qhybrid.QHybridSupport.QHYBRID_EVENT_MULTI_BUTTON_PRESS;
...
public class FossilWatchAdapter extends WatchAdapter {
    ...
    public void vibrate(org.likeapp.likeapp.service.devices.qhybrid.requests.misfit.PlayNotificationRequest.VibrationType vibration) {
        // queueWrite(new org.likeapp.likeapp.service.devices.qhybrid.requests.misfit.PlayNotificationRequest(vibration, -1, -1));
    }
    ...
    public void onSetAlarms(ArrayList<? extends Alarm> alarms) {
       //  throw new RuntimeException("noope");
        ArrayList<org.likeapp.likeapp.service.devices.qhybrid.requests.fossil.alarm.Alarm> activeAlarms = new ArrayList<>();
