...
import org.likeapp.likeapp.export.GPXExporter;
...
//        }
        ...
        if (success) {
            ...
            try {
                ...
                String fileName = FileUtils.makeValidFileName("likeapp-"+trackType.toLowerCase()+"-" + DateTimeUtils.formatIso8601(summary.getStartTime()) + ".gpx");
    ...
    protected void handleActivityNotif(byte[] value) {
        LOG.debug ("sports details: " + GB.hexdump (value, true));
