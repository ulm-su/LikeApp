...
package org.likeapp.likeapp.service.devices.huami.amazfitbips;
...
import org.likeapp.likeapp.service.devices.huami.amazfitbip.AmazfitBipFirmwareInfo;
    ...
    protected HuamiFirmwareType determineFirmwareType(byte[] bytes) {
        ...
        if (device != null) {
            if (device.getFirmwareVersion().startsWith("2.")) {
                ...
                //For devices on firmware 4.x it is a dth device and needs a header which looks like Bip
