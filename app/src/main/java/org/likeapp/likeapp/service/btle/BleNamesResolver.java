...
public class BleNamesResolver {
	...
	static {
		...
		mCharacteristics.put("0000fed0-0000-1000-8000-00805f9b34fb", "Custom UUID of Apple, Inc.");
		mCharacteristics.put("0000fed1-0000-1000-8000-00805f9b34fb", "Custom UUID of Apple, Inc.");
		mCharacteristics.put("0000fed2-0000-1000-8000-00805f9b34fb", "Custom UUID of Apple, Inc.");
		mCharacteristics.put("0000fed3-0000-1000-8000-00805f9b34fb", "Custom UUID of Apple, Inc.");
		mCharacteristics.put("0000fed4-0000-1000-8000-00805f9b34fb", "Custom UUID of Apple, Inc.");
		mCharacteristics.put("0000fed5-0000-1000-8000-00805f9b34fb", "Custom UUID of Plantronics Inc.");
		mCharacteristics.put("0000fed6-0000-1000-8000-00805f9b34fb", "Custom UUID of Broadcom Corporation");
		mCharacteristics.put("0000fed7-0000-1000-8000-00805f9b34fb", "Custom UUID of Broadcom Corporation");
		mCharacteristics.put("0000fed8-0000-1000-8000-00805f9b34fb", "Custom UUID of Google Inc.");
		mCharacteristics.put("0000fed9-0000-1000-8000-00805f9b34fb", "Custom UUID of Pebble Technology Corporation");
		mCharacteristics.put("0000feda-0000-1000-8000-00805f9b34fb", "Custom UUID of ISSC Technologies Corporation");
		mCharacteristics.put("0000fedb-0000-1000-8000-00805f9b34fb", "Custom UUID of Perka, Inc.");
		mCharacteristics.put("0000fedc-0000-1000-8000-00805f9b34fb", "Custom UUID of Jawbone");
		mCharacteristics.put("0000fedd-0000-1000-8000-00805f9b34fb", "Custom UUID of Jawbone");
		mCharacteristics.put("0000fede-0000-1000-8000-00805f9b34fb", "Custom UUID of Coin, Inc.");
		mCharacteristics.put("0000fedf-0000-1000-8000-00805f9b34fb", "Custom UUID of Design SHIFT");

		mCharacteristics.put("00000001-0000-3512-2118-0009af100700", "Sensor Control");
		mCharacteristics.put("00000002-0000-3512-2118-0009af100700", "Sensor Data");
		mCharacteristics.put("00000003-0000-3512-2118-0009af100700", "Configuration");
		mCharacteristics.put("00000004-0000-3512-2118-0009af100700", "Fetch");
		mCharacteristics.put("00000005-0000-3512-2118-0009af100700", "Activity Data");
		mCharacteristics.put("00000006-0000-3512-2118-0009af100700", "Battery Info");
		mCharacteristics.put("00000007-0000-3512-2118-0009af100700", "Realtime Steps");
		mCharacteristics.put("00000008-0000-3512-2118-0009af100700", "User Settings");
		mCharacteristics.put("00000009-0000-3512-2118-0009af100700", "Authentication");
		mCharacteristics.put("0000000e-0000-3512-2118-0009af100700", "Weather");
		mCharacteristics.put("00000010-0000-3512-2118-0009af100700", "Device Event");
		mCharacteristics.put("00000012-0000-3512-2118-0009af100700", "Audio");
		mCharacteristics.put("00000013-0000-3512-2118-0009af100700", "Audio Data");
		mCharacteristics.put("00000020-0000-3512-2118-0009af100700", "Chunked Transfer");
		mCharacteristics.put("00001531-0000-3512-2118-0009af100700", "Firmware");
		mCharacteristics.put("00001532-0000-3512-2118-0009af100700", "Firmware Data");
