...
public class GBDeviceAdapterv2 extends RecyclerView.Adapter<GBDeviceAdapterv2.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        if (batteryLevel != GBDevice.BATTERY_UNKNOWN) {
            ...
            int life = device.getBatteryLife ();
            if (life >= 0)
            {
                holder.batteryLifeLabel.setText (context.getString (R.string.battery_life, life / 24, life % 24));
            }
            else
            {
                holder.batteryLifeLabel.setText (null);
            }
        ...
        int steps = device.getSteps ();
        if (steps > 0)
        {
            holder.stepsLabel.setText (String.format (Locale.getDefault (), "%d", steps));
        }
        else
        {
            holder.stepsLabel.setText (null);
        }

        int distance = device.getDistance ();
        if (distance > 0)
        {
            holder.distanceLabel.setText (context.getString (R.string.action_distance, distance / 1000.0));
        }
        else
        {
            holder.distanceLabel.setText (null);
        }
...
//                                                             });
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            batteryLifeLabel = view.findViewById(R.id.battery_life);
            ...
            stepsLabel = view.findViewById(R.id.action_steps);
            distanceLabel = view.findViewById(R.id.action_distance);
