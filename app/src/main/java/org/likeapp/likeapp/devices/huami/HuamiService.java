...
import static org.likeapp.likeapp.service.btle.AbstractBTLEDeviceSupport.BASE_UUID;
...
public class HuamiService {
    ...
    public static final UUID UUID_CHARACTERISTIC_1_SENSOR_DATA = UUID.fromString("00000002-0000-3512-2118-0009af100700");
    /**
    ...
    public static final UUID UUID_CHARACTERISTIC_4_FETCH = UUID.fromString("00000004-0000-3512-2118-0009af100700");
