 ...
 */
package org.likeapp.likeapp.daogen;
...
public class GBDaoGenerator {
    ...
    private static final String MAIN_PACKAGE = "org.likeapp.likeapp";
    ...
    private static void addAlarms(Schema schema, Entity user, Entity device) {
        ...
        alarm.implementsInterface("org.likeapp.likeapp.model.Alarm");
